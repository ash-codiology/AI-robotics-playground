...
- [X] T013 Create `book/docusaurus.config.js` with base configuration
- [X] T014 Configure Docusaurus sidebar mapping for modules in `book/docusaurus.config.js`
- [X] T015 Implement Docusaurus search (Algolia or local) in `book/docusaurus.config.js`
- [X] T016 Implement Docusaurus dark/light toggle in `book/docusaurus.config.js`
- [X] T017 Configure "Open in GitHub" edit link on Docusaurus pages
...
- [X] T023 [P] [US2] Create `book/docs/module-1-ros2/index.md` for Module 1 (ROS2)
- [X] T024 [P] [US2] Create `book/examples/01_ros2/README.md`
- [X] T025 [P] [US2] Create `book/examples/01_ros2/package_ros2_baseline/` directory
- [X] T026 [P] [US2] Create `book/examples/01_ros2/tests/test_ros_nodes.sh`
- [X] T027 [US2] Add content for ROS 2 Concepts (DDS, nodes/topics/services/actions, QoS, parameters) to `book/docs/module-1-ros2/index.md`
- [X] T028 [US2] Add content for ROS 2 Tooling (`rclpy`, `ros2 CLI`, launch system, `ros2bag`, `VERSIONS.md`) to `book/docs/module-1-ros2/index.md`
- [X] T029 [US2] Add implementation walkthrough (teleop → controller → actuator chain; sample humanoid URDF) to `book/docs/module-1-ros2/index.md`
- [X] T030 [US2] Add case study (head+arm control demo with sensor feedback) to `book/docs/module-1-ros2/index.md`
- [X] T031 [US2] Add mini project (voice→action stub dry-run) to `book/docs/module-1-ros2/index.md`
- [X] T032 [US2] Add debugging (QoS mismatch, missing transforms, permission errors) to `book/docs/module-1-ros2/index.md`
...
- [X] T033 [P] [US3] Create `book/docs/module-2-simulation/index.md` for Module 2 (Simulation)
- [X] T034 [P] [US3] Create `book/examples/02_simulation/README.md`
- [X] T035 [P] [US3] Create `book/examples/02_simulation/gazebo_worlds/` directory
- [X] T036 [P] [US3] Create `book/examples/02_simulation/tests/test_sim_stability.sh`
- [X] T037 [US3] Add content for Concepts (URDF/SDF, dynamics, frames & TF) to `book/docs/module-2-simulation/index.md`
- [X] T038 [US3] Add content for Tooling (`ros_gz` bridge, Unity robotics toolkit) to `book/docs/module-2-simulation/index.md`
- [X] T039 [US3] Add implementation walkthrough (spawn URDF, attach camera/IMU, record rosbag) to `book/docs/module-2-simulation/index.md`
- [X] T040 [US3] Add case study (pick-and-place in Gazebo) to `book/docs/module-2-simulation/index.md`
- [X] T041 [US3] Add mini project (60s stability test, sensor output validation) to `book/docs/module-2-simulation/index.md`
- [X] T042 [US3] Add debugging (bad inertias, joint limits, frame mismatches) to `book/docs/module-2-simulation/index.md`
...
- [X] T043 [P] [US4] Create `book/docs/module-3-isaac/index.md` for Module 3 (Isaac)
- [X] T044 [P] [US4] Create `book/examples/03_isaac/README.md`
- [X] T045 [P] [US4] Create `book/examples/03_isaac/isaac_scenes/` directory
- [X] T046 [P] [US4] Create `book/examples/03_isaac/tests/test_vslam_nav2.py`
- [X] T047 [US4] Add content for Concepts (synthetic data, domain randomization, USD scenes, sim2real) to `book/docs/module-3-isaac/index.md`
- [X] T048 [US4] Add content for Tooling (Isaac Sim, Isaac ROS adapters, Nav2 integration, GPU constraints) to `book/docs/module-3-isaac/index.md`
- [X] T049 [US4] Add implementation walkthrough (synthetic data -> small model or plug-in pretrained model -> run VSLAM + Nav2) to `book/docs/module-3-isaac/index.md`
- [X] T050 [US4] Add case study (Nav2 path from VSLAM-generated map) to `book/docs/module-3-isaac/index.md`
- [X] T051 [US4] Add mini project (train/validate tiny detector on Isaac synthetic samples) to `book/docs/module-3-isaac/index.md`
- [X] T052 [US4] Add debugging (GPU OOMs, mismatched package versions, missing USD stages) to `book/docs/module-3-isaac/index.md`
...
- [X] T053 [P] [US5] Create `book/docs/module-4-vla/index.md` for Module 4 (VLA)
- [X] T054 [P] [US5] Create `book/examples/04_vla/README.md`
- [X] T055 [P] [US5] Create `book/examples/04_vla/whisper_examples/` directory
- [X] T056 [P] [US5] Create `book/examples/04_vla/tests/test_vla_pipeline.sh`
- [X] T057 [US5] Add content for Concepts (ASR → LLM → symbolic plan → ROS action graph; safety & verification) to `book/docs/module-4-vla/index.md`
- [X] T058 [US5] Add content for Tooling (Whisper audio pipeline, chosen LLM client, executor patterns in ROS2) to `book/docs/module-4-vla/index.md`
- [X] T059 [US5] Add implementation walkthrough (WAV → transcript → templated prompt → deterministic plan → ROS action sequence) to `book/docs/module-4-vla/index.md`
- [X] T060 [US5] Add case study (“place red cup on table” end-to-end in sim) to `book/docs/module-4-vla/index.md`
- [X] T061 [US5] Add mini project (deterministic mapping from LLM response to ROS actions with retries/fallbacks) to `book/docs/module-4-vla/index.md`
- [X] T062 [US5] Add debugging (ASR noise, LLM hallucination mitigation, action failure handling) to `book/docs/module-4-vla/index.md`
...
- [X] T063 Create `book/capstone/run_capstone.sh`
- [X] T064 Create `book/capstone/docker/` directory
- [X] T065 Add Docker/compose configuration for the Capstone project in `book/capstone/docker/`
- [X] T066 Add evaluation script placeholder in `book/capstone/`
- [X] T067 Add reproducibility checklist placeholder in `book/capstone/`
- [X] T068 Integrate representative examples from all modules into `book/capstone/run_capstone.sh`
...
- [X] T069 [P] Create `book/assets/screenshots/` directory
- [X] T070 [P] Create `book/assets/small_rosbags/` directory
- [X] T071 [P] Create `book/assets/usd_samples/` directory
- [X] T072 Review and refine `book/VERSIONS.md` for all dependencies and versions
...
```bash
# Launch creation of core module files together:
Task: "Create book/docs/module-1-ros2/index.md for Module 1 (ROS2)"
Task: "Create book/examples/01_ros2/README.md"
Task: "Create book/examples/01_ros2/package_ros2_baseline/ directory"
Task: "Create book/examples/01_ros2/tests/test_ros_nodes.sh"
```
